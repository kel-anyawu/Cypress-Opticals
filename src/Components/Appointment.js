...
// }
    ...
    return (
        <div>
            <section id="appointment" className="appointment section-bg mt-5">
                <div className="container mt-5">

                    <div className="section-title">
                        <h2>Make an Appointment</h2>
                        <p>Please fill this form to make an Appointment. A member of staff will get back to you in an hour or less.</p>
                    </div>
